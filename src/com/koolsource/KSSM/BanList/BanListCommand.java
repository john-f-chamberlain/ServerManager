...
public class BanListCommand implements CommandExecutor {
    ...
    public boolean warnPlayer(CommandSender anAdmin, String[] arguments) {
        if (!this.perms.has(anAdmin, "KSSM.Banlist.warn")) {
            Main.noPermission((Player) anAdmin);
            return true;
        }
    ...
    public boolean kickPlayer(CommandSender anAdmin, String[] arguments) {
        if (!this.perms.has(anAdmin, "KSSM.Banlist.kick")) {
            Main.noPermission((Player) anAdmin);
            return true;
        }
        if (arguments.length < 2) {
    ...
    public boolean banPlayer(CommandSender anAdmin, String[] arguments) {
        if (!this.perms.has(anAdmin, "KSSM.Banlist.ban")) {
            Main.noPermission((Player) anAdmin);
            return true;
        }
